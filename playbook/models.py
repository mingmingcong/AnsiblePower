...
class AnsiblePlaybook(models.Model):
    ...
    playbook_hosts = models.CharField(max_length=45, blank=True, null=True, verbose_name='hosts')
...
class AnsiblePlaybookHandler(models.Model):
    handler_name = models.CharField(max_length=45, blank=True, null=True, verbose_name='handler')
    module_args = models.CharField(max_length=45, blank=True, null=True)
...
class AnsiblePlaybookTask(models.Model):
    task_name = models.CharField(max_length=45, blank=True, null=True, verbose_name='task')
